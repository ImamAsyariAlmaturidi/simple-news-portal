...
const AddFormUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://server.imam-asyari.online/user/add-user",
        {
          email,
          password,
          username,
      ...
      if(error.response.data.message === 'email must be unique'){
        Toastify({
          text: `email already taken, please using another email`,
          duration: 2000,
          newWindow: false,
          close: true,
          gravity: "bottom",
  ...
  return (
    <div
      className="flex flex-col items-center p-8 bg-cover bg-center bg-no-repeat py-64"
      style={{
        backgroundImage:
          'url("https://wallpapers.com/images/hd/sunset-view-aesthetic-anime-couple-dy2za3mf25sxevmm.jpg")',
      }}
    >
      <div className="bg-white bg-opacity-80 p-8 rounded-xl shadow-xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col mb-4 w-full">
            <label
              htmlFor="email"
              className="mb-2 text-gray-800 font-semibold text-lg flex items-center"
            >
              <svg
          ...
          <div className="flex flex-col mb-4 w-full">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M19 13H5v-2h14v2zm0-4H5V7h14v2zm0-4H5V3h14v2zm0 16H5v-2h14v2zm4-2V3H1v14h22z" />
              </svg>
              Password
            </label>
            <input
          ...
          <div className="flex flex-col mb-4 w-full">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M22 7V4h-2V2H4v2H2v3h20zM2 21h20v-8H2v8zm16-9H6v2h12v-2zm0-4H6v2h12V8zm-4 4h-4v2h4v-2z" />
              </svg>
              Username
            </label>
            <input
          ...
          <div className="flex flex-col mb-4 w-full">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M3 11h18v2H3zm0 4h18v2H3zm0 4h18v2H3zm0-12h18v2H3zm0-4h18v2H3z" />
              </svg>
              phoneNumber
            </label>
            <input
